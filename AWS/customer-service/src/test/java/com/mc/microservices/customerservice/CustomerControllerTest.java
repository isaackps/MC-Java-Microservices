...
class CustomerControllerTest {
	...
	void retrieveAllCustomersTest() throws Exception {
		...
		mockMvc.perform(get("/api/getAllCustomer")).andExpect(status().isOk());
	...
	void retrieveCustomerTest() throws Exception {
		...
		mockMvc.perform(get("/api/getCustomer/{username}", "isaac")).andExpect(status().isOk());
	...
	void updateCustomerDetailsTest() throws Exception {
		...
		mockMvc.perform(put("/api/updateDetails")
				.contentType(MediaType.APPLICATION_JSON)
				.content(payload))
				.andExpect(status().isOk());
